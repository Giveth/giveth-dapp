...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c148 = "constructor",
      peg$c149 = peg$literalExpectation("constructor", false),
      peg$c150 = "days",
      peg$c151 = peg$literalExpectation("days", false),
      peg$c152 = "delete",
      peg$c153 = peg$literalExpectation("delete", false),
      peg$c154 = "do",
      ...
      peg$c288 = function(literal, members, parts) {
          return {
            type: "Type",
      ...
      peg$c289 = function(funcName, modifiers, returns, parts) {
            return {
              type: "Type",
              literal: "function",
      ...
      peg$c296 = function(expression) {
          return expression;
        },
      peg$c297 = function(type, specifiers, id, value) {
          return {
      ...
      peg$c298 = function(type, storage, id) {
          return {
      ...
      peg$c302 = function(argument, operator) {
            return {
      ...
      peg$c307 = function(operator, argument) {
      ...
      peg$c316 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c317 = "*",
      ...
      peg$c361 = function(test, consequent, alternate) {
            return {
      ...
      peg$c363 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c387 = function(head, tail) { return buildList(head, tail, 1); },
      peg$c388 = function(declarations) {
            return {
      ...
      peg$c390 = function(head, tail, init) {
            return {
              declarations: buildList(head, tail, 1),
              init: extractOptional(init, 1)
            }
          },
      peg$c391 = function(id) {
            return {
      ...
      peg$c393 = function(expression) { return expression; },
      peg$c394 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      ...
      peg$c396 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c397 = function(test, consequent) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c398 = function(start_version, end_version) {
          return {
      ...
      peg$c402 = function(symbols, from) {
          return {
            type: "ImportStatement",
            from: from.value,
            symbols: symbols,
      ...
      peg$c403 = function(library, type) {
          return {
            type: "UsingStatement",
      ...
      peg$c408 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test, start: location().start.offset, end: location().end.offset }; },
      peg$c409 = function(test, body) { return { type: "WhileStatement", test: test, body: body, start: location().start.offset, end: location().end.offset }; },
      peg$c410 = function(init, test, update, body) {
            return {
              type:   "ForStatement",
      ...
      peg$c411 = function(declarations, test, update, body) {
            return {
              type:   "ForStatement",
              init:   {
                type:         "VariableDeclaration",
      ...
      peg$c412 = "assembly",
      peg$c413 = peg$literalExpectation("assembly", false),
      ...
      peg$c427 = function(fnname, isanonymous) {
          return {
      ...
      peg$c428 = function(fnname, names, body) {
            return {
      ...
      peg$c429 = function(fnname, args, returns, body) {
            return {
      ...
      peg$c430 = function(fnname, args, returns) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c431 = function(fnname, args, body) {
            return {
      ...
      peg$c432 = function(params) {
          return params != null ? params [2] : null;
        },
      peg$c433 = function(returnParams) {
      ...
      peg$c437 = function(alias, modifier) {
            if (alias.length > 0) {
      ...
      peg$c438 = function(type, isindexed, isconstant, isstorage, ismemory, id) {
          return {
      ...
      peg$c440 = function(id, head, tail) {
          return {
      ...
      peg$c445 = "let",
      peg$c446 = peg$literalExpectation("let", false),
      peg$c447 = ":=",
      ...
      peg$c458 = function(init, test, update, body) {
          return {
            type: "AssemblyFor",
            init: init,
            test: test,
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          peg$savedPos = s0;
                          s1 = peg$c438(s1, s3, s5, s7, s9, s11);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$FAILED;
