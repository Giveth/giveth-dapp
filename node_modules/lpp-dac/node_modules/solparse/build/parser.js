...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c384 = function(expression) { return expression; },
      peg$c385 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      peg$c386 = function(expression) {
            return {
      ...
      peg$c387 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c388 = function(test, consequent) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c389 = function(start_version, end_version) {
          return {
      ...
      peg$c393 = function(symbols, from) {
          return {
            type: "ImportStatement",
            from: from.value,
            symbols: symbols,
      ...
      peg$c394 = function(library, type) {
          return {
            type: "UsingStatement",
      ...
      peg$c400 = function(init, test, update, body) {
            return {
              type:   "ForStatement",
      ...
      peg$c401 = function(declarations, test, update, body) {
            return {
              type:   "ForStatement",
              init:   {
                type:         "VariableDeclaration",
      ...
      peg$c402 = "assembly",
      peg$c403 = peg$literalExpectation("assembly", false),
      ...
      peg$c417 = function(fnname, isanonymous) {
          return {
      ...
      peg$c418 = function(fnname, names, body) {
            return {
      ...
      peg$c419 = function(fnname, args, returns, body) {
            return {
      ...
      peg$c420 = function(fnname, args, returns) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c425 = function(type, isindexed, isconstant, isstorage, ismemory, id) {
          return {
      ...
      peg$c427 = function(id, head, tail) {
          return {
      ...
      peg$c432 = "let",
      peg$c433 = peg$literalExpectation("let", false),
      peg$c434 = ":=",
      ...
      peg$c437 = function(name, expression) {
          return {
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          peg$savedPos = s0;
                          s1 = peg$c425(s1, s3, s5, s7, s9, s11);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$FAILED;
