...
class Application extends Component {
  constructor() {
    ...
    this.state = {
      ...
      hasError: false,
      wallet: undefined,
      unlockWallet: false, // eslint-disable-line react/no-unused-state
      cachedWallet: true, // eslint-disable-line react/no-unused-state
      alerts: [], // eslint-disable-line react/no-unused-state
    };
  ...
  componentWillMount() {
    ...
    GivethWallet.getCachedKeystore()
      ...
      .catch((err) => {
        ...
        this.setState({
          cachedWallet: false, // eslint-disable-line react/no-unused-state
        });
      });
  ...
  walletUnlocked() {
    ...
    React.toast.success((
      <p>Your wallet has been unlocked.<br />
        ...
        {!isLoading && !hasError &&
          <div>
            ...
            <Switch>
              ...
              <Route exact path="/dacs/new" component={props => <EditDAC isNew currentUser={currentUser} walletUnlocked={wallet} {...props} />} />
              ...
              <Route exact path="/campaigns/new" component={props => <EditCampaign isNew currentUser={currentUser} wallet={wallet} {...props} />} />
              ...
              <Route exact path="/campaigns/:id/milestones/new" component={props => <EditMilestone isNew currentUser={currentUser} wallet={wallet} {...props} />} />
